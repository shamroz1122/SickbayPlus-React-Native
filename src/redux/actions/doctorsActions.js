        ...
        .then((res) => {
          //console.log(res.data)
               ...
               {       
                        ...
                        dispatch({type: 'GET_DOCTORS_SUCCESS',doctors:res.data.result.data})
               } 
...
export const clearDoctors = Data => dispatch => {
...
export const loadingFlagDoc = Data => dispatch => {
    dispatch({type: 'DOC_LOADING',loading:true})
}
