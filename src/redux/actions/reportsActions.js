...
export const getReports = Data => dispatch => {
        ...
        .then((res) => {
               ...
               {       
                        ...
                        dispatch({type: 'GET_REPORTS_SUCCESS',reports:res.data.result})
               } 
...
export const loadingFlagReport = Data => dispatch => {
        dispatch({type: 'REPORT_LOADING',loading:true})
}
